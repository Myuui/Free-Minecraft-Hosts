...
|--|--|--|--|--|--|--|--|--|--|--|--|--|
![](https://cdn.trustpilot.net/brand-assets/4.1.0/stars/stars-4.svg) 4.2 ⭐|❌ (out of stock)|omgserv.com | 1 GB | 4 | 3.3GHZ (XEON E5-2670) | Unlimited | France 🇫🇷 / USA :us: |❌| [🌐](https://www.omgserv.com/en/hosting/minecraft-server/free/) |❌|✅| Out of Stock (11/Oct/2023)
...
![](https://cdn.trustpilot.net/brand-assets/4.1.0/stars/stars-4.5.svg) 4.4 ⭐|❌ (Not available)|scalacube.com|6 GB|Unlimited|3.4 GHz (Intel/ AMD Xeon ❔)|30 GB|Canada 🇨🇦 / France 🇫🇷 / United Kingdom 🇬🇧 / Australia 🇦🇺 / Singapore 🇸🇬|❔|[🌐](https://scalacube.com/hosting/server/minecraft/constructor/public)|❌|✅|Only Vanilla and Snapshots|
![](https://cdn.trustpilot.net/brand-assets/4.1.0/stars/stars-4.5.svg) 4.5 ⭐|Single: 209  Multi: 521|falixnodes.net|6+ GB|Unlimited|5.9 GHz (Ryzen 9 7950X)|20 GB|USA :us: / Germany 🇩🇪|❌|[🌐](https://falixnodes.net/)|❌|✅|Custom subdomain, Modded servers allowed, Scheduled backups, Scheduled tasks, MySQL database, Technical support.|
...
![](https://cdn.trustpilot.net/brand-assets/4.1.0/stars/stars-4.svg) 4 ⭐||freemcserver.net|1.5 GB (+200 if Forge)|Unlimited|3.35 GHz (EPYC 7502P)|10 GB|USA :us: / Germany :de: / France :fr:|✅|[🌐](https://freemcserver.net/)|❌|✅|--|
...
|![](https://cdn.trustpilot.net/brand-assets/4.1.0/stars/stars-4.svg) 3.8 ⭐||optikservers.com|❔|❔|4.9 GHz (Ryzen 9 5950x)|❔|Germany :de:|✅|[🌐](https://optikservers.com/)|❌|✅|--|
