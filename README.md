...
![](https://cdn.trustpilot.net/brand-assets/4.1.0/stars/stars-4.5.svg) 4.4 ⭐|❌ (Not available)|scalacube.com|6 GB|Unlimited|3.4 GHz (Intel/ AMD Xeon ❔)|30 GB|Canada 🇨🇦 / France 🇫🇷 / United Kingdom 🇬🇧 / Australia 🇦🇺 / Singapore 🇸🇬|❔|[🌐](https://scalacube.com/hosting/server/minecraft/constructor/public)|❌|✅|Free plans do not have the ability to edit,add or replace files, Only Vanilla and Snapshots Minecraft.|
![](https://cdn.trustpilot.net/brand-assets/4.1.0/stars/stars-4.5.svg) 4.4 ⭐|Single: 209  Multi: 521|falixnodes.net|6+ GB|Unlimited|5.7 GHz (Ryzen 9 7950X3D)|15 GB|USA :us: / Germany 🇩🇪|❌|[🌐](https://falixnodes.net/)|❌|✅|Custom subdomain, Modded servers allowed, Scheduled backups, Scheduled tasks, MySQL database, Technical support.|
